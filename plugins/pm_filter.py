        ...
        btn = [
            [
                InlineKeyboardButton(
                    ...
                    url= short_url(f"https://t.me/{temp.U_NAME}?start=files_{file.file_id}")
                ),
            ]
            for file in files
        ]
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('Tʜɪs Mᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ ʟᴇᴀᴠᴇ ᴀ ᴍᴇssᴀɢᴇ ʙᴇʟᴏᴡ 😌 \n\nᴇxᴀᴍᴘʟᴇ : \nᴇɴᴛᴇʀ ʏᴏᴜʀ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ (ʏᴇᴀʀ) ᴛᴀɢ @admin')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Movies Group', url=YOUR_GROUP),
            InlineKeyboardButton('Updates', url=YOUR_CHANNEL)
        ], [
    ...
    if settings["button"]:
        btn = [
            [
                InlineKeyboardButton(
                    text=f"[{get_size(file.file_size)}] {file.file_name}", 
                    url= short_url(f"https://t.me/{temp.U_NAME}?start=pre_{file.file_id}")
                ),
            ]
            for file in files
        ]
    ...
    if imdb and imdb.get('poster'):
        try:
            ...
            await client.send_video(
                ...
                video="https://graph.org/file/881ea9001c8c9d51edc3f.mp4",
